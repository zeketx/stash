...
- [ ] Keep logs in: `~/.local/share/ytdl/logs/` (Linux/macOS) or appropriate Windows location
...
Once Phase 1 is complete, proceed to [Phase 2: Beautiful TUI](phase-02-beautiful-tui.md)
